...
Button {
    ...
    property real buttonRadius: Appearance.sizes.cornerRadiusSmall
    ...
    property color colBackground: ColorUtils.transparentize(Appearance.colors.surfaceHover, 1) || "transparent"
    property color colBackgroundHover: Appearance.colors.surfaceHover
    property color colBackgroundToggled: Appearance.colors.primary
    property color colBackgroundToggledHover: Appearance.colors.primary
    property color colRipple: Appearance.colors.surfaceHover
    property color colRippleToggled: Appearance.colors.primary
    ...
    component RippleAnim: NumberAnimation {
        ...
        easing.bezierCurve: Appearance.animation.bezierStandard
    }
    ...
    MouseArea {
        ...
        onReleased: (event) => {
            ...
            if (root.releaseAction) {
                if (root.releaseAction() === true) return;
            }
    ...
    background: Rectangle {
        ...
        Item {
            ...
            Behavior on opacity {
               NumberAnimation { duration: Appearance.animation.durationFast }
            }
