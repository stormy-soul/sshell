...
GroupButton {
    ...
    // Sizing shenanigans
    baseWidth: root.baseCellWidth * cellSize + cellSpacing * (cellSize - 1) //expandedSize ? root.baseCellWidth * cellSize + cellSpacing * (cellSize - 1) : (root.baseCellWidth * cellSize + cellSpacing * (cellSize - 1)) / 1.2 
    ...
    buttonRadius: toggled ? Appearance.rounding.large : Appearance.rounding.normal
